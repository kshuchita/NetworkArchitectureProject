...
while text == "y":
  ...
  text=raw_input('Enter your message:') #take message input from user
  ...
  if msg1 == "bye from server":
   ...
   print(msg2)
   text = raw_input("Do you want to continue ?(y/n)")
   if text == "y":
    ...
    if dmsg == "bye from server":
     ...
     text= "bye from client" #take message input from user
     s.send(text.encode('ascii'))
	 s.close